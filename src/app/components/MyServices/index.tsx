...
<h1 className='fw-bold display-3 text-white'>Lorem Ipsum <span className='text-red'>Dolor</span></h1>
        ...
        <p className='text-white small'>
          ...
          estamos aqui para transformar suas ideias em realidade com tecnologia de ponta.</p>
        <div className="row row-cols-1 row-cols-md-3 g-4">
  
          
            <CardService icon={Code} 
            ...
            <CardService icon={TerminalWindow} title='teste' 
            ...
            <CardService icon={Robot} title='teste' 
